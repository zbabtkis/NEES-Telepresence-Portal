define(['Model/FrameRate','app.settings','underscore', 'backbone'], function(FrameRate, settings) {
	var Camera = Backbone.Model.extend({
        ...
        initialize: function() {
			...
			this.listenTo(FrameRate, 'change', this.getStream);
		},
        // update requestAddress with location/view of current selection
        getStream: function() {
        	console.log(this.get('feed'));
